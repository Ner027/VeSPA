...
#
# Script generated by Vivado on Mon Dec 11 10:14:09 WET 2023
...
#
# Usage        : mem_ip.sh
#                mem_ip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mem_ip.sh [-reset_run]
#                mem_ip.sh [-reset_log]
#                mem_ip.sh [-help]
#
...
# script info
echo -e "mem_ip.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mem_ip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mem_ip xil_defaultlib.mem_ip xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mem_ip -key {Behavioral:sim_1:Functional:mem_ip} -tclbatch cmd.tcl -protoinst "protoinst_files/mem_ip.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mem_ip.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mem_ip.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mem_ip.sh [-help]\n\
Usage: mem_ip.sh [-step]\n\
Usage: mem_ip.sh [-lib_map_path]\n\
Usage: mem_ip.sh [-reset_run]\n\
Usage: mem_ip.sh [-reset_log]\n\
Usage: mem_ip.sh [-keep_index]\n\
Usage: mem_ip.sh [-noclean_files]\n\n\
